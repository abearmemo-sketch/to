    ...
    try {
        ...
        if (req.method === 'POST') {
            ...
            if (action === 'start') {
                ...
                const startRes = await fetch("https://api.track.toggl.com/api/v9/workspaces/20754678/time_entries", {
                    method: 'POST',
                    headers,
                    body: JSON.stringify({
                ...
                const stopRes = await fetch(`https://api.track.toggl.com/api/v9/workspaces/20754678/time_entries/${currentTimer.id}/stop`, {
                    method: 'PATCH',
                    headers,
                });
                ...
                const updateRes = await fetch(`https://api.track.toggl.com/api/v9/workspaces/20754678/time_entries/${id}`, {
                    method: 'PUT',
                    headers,
                    body: JSON.stringify({
                        description: description,
